...
There are numerous ways data science is applied in day-to-day life. One instance is the use of data science in insurance policy making. The insurance underwriter analyzes the data that is relevant to the insurer and insured to calculate the risks of every insurance policy before it is sold as premiums with a definite price, options, and deals that is agreeable for both insurance companies and its customers. 

### Propose at least one data science topic that you want to pursue: Have a broad description of the topic, describe the availability of the data, what kinds of statistical method you think you will need, and who would benefit this study.

#### Day Trading

Markets such as the stock market, forex, and cryptocurrencies became popular topics of the finance world. 